<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="StudentComment.aspx.cs" Inherits="RPSWebsiteCSharp.Admin.StudentComment" %>
         ...
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="panel-body">
                    <asp:GridView ID="GridView1" ShowHeaderWhenEmpty="True" HeaderStyle-CssClass="bg-info text-white text-center" runat="server"
                        ...
                        <Columns>
                            <asp:BoundField HeaderText="ID" DataField="commentid" Visible="false" />
                            ...
                            <asp:TemplateField HeaderText="Delete">
                                <ItemTemplate>
                                    <asp:ImageButton ID="lnk_Delete" runat="server" ImageUrl="../Appmedia/buttons/delete50.png" Width="30" Height="30" CommandName="Delete" CommandArgument='<%# Eval("commentid") %>' OnClientClick="return ConfirmDelete(this);" ToolTip="Delete" CausesValidation="false" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
